...
function CourseDetails() {
    ...
    return courseData ? (
        ...
        <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
           ...
           <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b  from-cyan-100/70'></div>{/* in this is the custom css */}

                {/* left column */}
                <div className='max-w-xl z-10 text-gray-500 '>

                    <h1 className='md:text-course-details-heading-small text-course-details-heading-large font-semibold text-gray-800'>{courseData.courseTitle}</h1>
                    <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html:courseData.courseDescription.slice(0,200)}}></p>{/* this will hide all the html text in the desc and enforce those tags */}

                    {/* review and ratings */}
                    <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>{/* from appContext */}
                                    ...
                                    <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                                        <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={()=>{toggleSection(index)}} >
                                            <div className='flex items-center gap-2'>
                                                <img className={`transform transition-transform ${openSections[index]?'rotate-180':''}`}//we are roatting the pic
                                        ...
                                        <div className={`overflow-hidden transition-all duration-30 ${openSections[index]?'max-h-96':'max-h-0'}`}>
                                                        ...
                                                        <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                                                            ...
                                                            <div className='flex gap-2'>
                                                                ...
                                                                onClick={()=>setPlayerData({
                                                                    videoId: lecture.lectureUrl.split('/').pop() //Understand
                                                                })}
                ...
                <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]' >
                    ...
                    <div className='p-5'>
                        ...
                        <div className='flex gap-3 items-center pt-2'>
                            ...
                            <p className='md:text-lg text-gray-800 line-through'>{currency}{courseData.coursePrice}</p>
                        ...
                        <div className='pt-6'>
                            ...
                            <ul className='mi-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                                ...
                                <li>Downloadab1e resources and source code.</li>
