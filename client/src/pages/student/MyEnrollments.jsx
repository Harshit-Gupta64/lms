...
import {Line} from 'rc-progress'//used for progress bar
            ...
            <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10'>
                ...
                <tbody className='text-gray-700'>
                    {enrolledCourses.map((course,index)=>(
                        <tr key={index} className='border-b border-gray-500/20 hover:bg-gray-100/50 text-sm max-sm:block max-sm:mb-5'>
