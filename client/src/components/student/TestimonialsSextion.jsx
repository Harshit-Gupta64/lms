        ...
        <div className='pb-14 px-8  md:px-0'>
            ...
            <div className='grid grid-cols-auto gap-8 mt-14'>
                {dummyTestimonial.map((testimonial,index)=>(
                    <div key={index} className='text-sm text-left border border-gray-500/30 pb-6 rpunded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
...
export default TestimonialsSextion
