...
function CoursesSection() {
    ...
    return (
        <div className='py-16 md:px-40 px-8'>
            <h2 className='rext-3xl font-medium text-gray-800'>Learn from the best</h2>
            ...
            <div className='grid grid-cols-auto px-4 md:px-0 md:my-16 my-10 gap-4'>
                {/* we want to show only 4 cards on home so we slices in 4 and map on all and pass the props to the card*/}
            ...
            {/* scrollTo: makes the page go to the top */}
        </div>
    )
}
